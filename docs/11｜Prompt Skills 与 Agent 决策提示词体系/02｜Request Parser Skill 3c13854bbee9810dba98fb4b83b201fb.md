# 02｜Request Parser Skill

## 对应文件

`prompts/02_request_parser.md`
...
只回答：**用户在问谁、什么时间、什么任务、什么指标、有什么约束，以及是否存在无法解析的引用。**
...
错误：看到“年报”就输出 `document_search`。

原因：本 Skill 只描述用户需求，**不做工具选择**。